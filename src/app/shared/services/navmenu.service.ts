...
export class NavmenuService {
  ...
  MENUITEMS: Menu[] = [
    ...
    },
    {
      id: 1,
      level: 1,
      title: 'dashboard', // Show active if the route calls for title
      icon: 'home',
      type: 'sub',
      active: true,
      children: [
        { path: '/dashboard/default', title: 'default', type: 'link' }, // Show active if the route calls for path
        // { path: "/dashboard/ecommerce", title: "Ecommerce", type: "link" },
        // {
        //   path: "/dashboard/project-deshboard",
        //   title: "Project",
        //   type: "link",
        // },
      ],
    ...
    //         },
    //         {
    //           path: "/form/form-controls/input-mask",
    //           title: "Input Mask",
    //           type: "link",
    //         },
    //         {
  ...
  MENUITEMS_ADMIN: Menu[] = [
    ...
    },
    {
      ...
      icon: 'user',
      type: 'link',
      path: '/administrador/solicitudes', // Path to redirect menu. This is a menu without children
    },
    {
      id: 2,
      level: 1,
      title: 'Catálogos', // Show active if the route calls for title
      icon: 'others',
      type: 'sub',
      active: false,
      children: [
        {
          path: '/administrador/catalogos/dependencias',
          title: 'Dependencias/Empresas',
          type: 'link',
        }, // Show active if the route calls for path
        {
          path: '/administrador/catalogos/proyectos',
          title: 'Proyectos',
          type: 'link',
        }, // Show active if the route calls for path
        {
          path: '/administrador/catalogos/programas',
          title: 'Programas educativos3',
          type: 'link',
        }, // Show active if the route calls for path
        {
          path: '/administrador/catalogos/periodos',
          title: 'Periodos',
          type: 'link',
        }, // Show active if the route calls for path
      ],
    },
    {
      ...
      icon: 'widget',
      type: 'link',
      path: '/administrador/notificaciones', // Path to redirect menu. This is a menu without children
    },
    {
      id: 4,
      level: 1,
      ...
      icon: 'editors',
      type: 'link',
      path: '/administrador/configuraciones', // Path to redirect menu. This is a menu without children
    },
  ];

  MENUITEMS_STUDENT: Menu[] = [
    {
      headTitle1: 'Menú Estudiante',
    },
    {
      id: 1,
      level: 1,
      ...
      icon: 'home',
      type: 'link',
      path: '/proceso', // Path to redirect menu. This is a menu without children
    },
    {
      id: 2,
      level: 1,
  ...
  item = new BehaviorSubject<Menu[]>(this.MENUITEMS_ADMIN);
  menuStudent = new BehaviorSubject<Menu[]>(this.MENUITEMS_STUDENT);
}
