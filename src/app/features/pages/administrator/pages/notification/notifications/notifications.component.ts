...
export class NotificationsComponent implements OnInit {
  ...
  async loadData(): Promise<void> {
    ...
    this.projects = [      
      { 
        id: 2, 
        name: 'Confirmación de Solicitud para Estancia Profesional', 
        areaId: 2, 
        areaName: 'Area 2', 
        cancellation: 'No', 
        cityId: '2', 
        cityName: 'Vista', 
        quota: Number('500'), 
        responsible: 'Iván Artemio Aguirre Salazar', 
        status: 'terminado', 
        typeId: '2', 
        typeName: '16/08/2024' 
      },
      { 
        ...
        areaId: 1, 
        areaName: 'Revisión de Documentos', 
        cancellation: 'No', 
        cityId: '1', 
        cityName: 'No vista', 
        quota: Number('500'), 
  ...
  openProject(): void {
    const modal = this._modalService.open(CreateNotificationComponent, {
      size: 'lg',
    });
